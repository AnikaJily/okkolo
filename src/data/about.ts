 ...
 * Фото команды и площадки загружаются из Strapi (about-team-photos /
 * about-workplace-photos); этот файл — fallback на случай недоступности CMS.
 */
...
/* ── Команда (слайд 7) — порядок как в деке ──────────────────────────
   Это FALLBACK: на сайте команда берётся из Strapi (`about-team-photos`,
   см. AboutPage.tsx). Здесь оставлены только участники, у которых есть фото
   в CMS (9 чел) — синхронно с живым составом. Те, для кого фото не загрузили
   (Усанова, Гаджиева, Ковтанюк, Шибаева, Шамыгина), убраны по просьбе
   заказчицы (2026-06-30). Появится фото — добавляй человека и в CMS, и сюда. */
