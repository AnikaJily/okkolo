...
export const WORKSHOPS_INTRO =
  'Мы учим профессиям: шить на производственных станках, работать бариста, делать звук и свет на мероприятиях. После обучения помогаем со стажировкой и трудоустройством. Мастерские открыты для молодых людей с инвалидностью.';

export const WORKSHOPS_AUDIENCE =
  'Мы ждём молодых людей с инвалидностью. Специальная подготовка не нужна, учим с нуля.';
