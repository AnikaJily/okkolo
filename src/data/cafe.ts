...
export interface CafeMenuItem {
  name: string;
  /** Объём, например «0,3» или «0,2/0,3» */
  volume?: string;
  price: string;
...
export const cafeMenus: CafeMenu[] = [
  {
    ...
    sections: [
      ...
      },
      {
        title: 'Чай',
        items: [
          { name: 'Чёрный чай', price: '140 ₽' },
          { name: 'Зелёный чай', price: '140 ₽' },
          { name: 'Чёрный чай с чабрецом', price: '150 ₽' },
          { name: 'Зелёный чай с жасмином', price: '150 ₽' },
    ...
    sections: [
      {
        ...
        items: [
          { name: 'Айс-латте', note: 'молоко, эспрессо, лёд', price: '220 ₽' },
          { name: 'Айс-матча', note: 'молоко, матча, лёд', price: '240 ₽' },
          {
            name: 'Айс-арахисовый капучино',
            note: 'молоко, эспрессо, арахисовая заготовка, лёд',
            price: '280 ₽',
          },
          {
            name: 'Айс-латте «Банановое мороженое»',
            note: 'молоко, эспрессо, заготовка, лёд',
            price: '280 ₽',
          },
          {
            name: 'Бамбл',
            note: 'сок, эспрессо, лёд; по желанию — сироп карамель',
            price: '250 ₽',
          },
          {
            name: 'Бамбл-матча',
            note: 'сок, матча, лёд; по желанию — сироп карамель',
            price: '250 ₽',
          },
        ],
      },
